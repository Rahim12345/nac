                ...
                <form action="{{ route('involve.store') }}" method="POST" enctype="multipart/form-data" class="mb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control @error('text_az') is-invalid  @enderror" name="text_az" id="text_az" value="{{ old('text_az',\App\Helpers\Involves::getOption('text_az')) }}">
                            @error('text_az')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control @error('text_en') is-invalid  @enderror" name="text_en" id="text_en" value="{{ old('text_en',\App\Helpers\Involves::getOption('text_en')) }}">
                            @error('text_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
