            ...
            <div class="mb-3 col-md-10 offset-md-1">
                <form action="{{ route('subscribe.store') }}" method="POST" enctype="multipart/form-data" class="mb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            @if(\App\Helpers\Subscribes::getOption('src_mobile') != '')
                                <img src="{{ asset('files/subscribe/'.\App\Helpers\Subscribes::getOption('src_mobile')) }}" alt="" style="width: 200px">
                            @endif
                        </div>
                    </div>
                    <div class="row">
...
{{--                        </div>--}}
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <textarea name="text_az" id="text_az" class="form-control @error('text_az') is-invalid  @enderror" cols="30" rows="4">{{ old('text_az',\App\Helpers\Subscribes::getOption('text_az')) }}</textarea>
                            @error('text_az')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <textarea name="text_en" id="text_en" class="form-control @error('text_en') is-invalid  @enderror" cols="30" rows="4">{{ old('text_en',\App\Helpers\Subscribes::getOption('text_en')) }}</textarea>
                            @error('text_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
